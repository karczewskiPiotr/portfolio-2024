...
export default function Sidebar() {
  ...
  return (
    <aside
      ref={aside}
      className="sticky top-16 col-span-1 col-start-12 flex h-fit flex-col items-end space-y-6 max-md:hidden"
    >
      <a
        aria-label="Email"
        data-animate="fade"
        ...
        <svg width="24" height="24" viewBox="0 0 16 16" fill="none">
          <g clipPath="url(#clip0_18_285)">
            <path
              ...
              className="fill-black-950 transition-all duration-500 group-hover:fill-copper-900 group-focus:fill-copper-900"
            />
          </g>
          <defs>
